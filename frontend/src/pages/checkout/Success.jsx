  ...
  return (
    <div className="max-w-xl mx-auto px-6 pt-40 pb-24 text-center space-y-6 font-sans">
      ...
      <div className="space-y-2">
        <h2 className="font-serif text-2xl md:text-3xl font-bold text-luxuryBlack">Payment Success!</h2>
      ...
      <div className="bg-surface border border-surface-container rounded-xl p-4 max-w-sm mx-auto space-y-2 text-xs">
        <div className="flex justify-between border-b border-surface-container/40 pb-2 text-secondary">
          ...
          <span className="font-semibold text-luxuryBlack">{orderNumber}</span>
        </div>
        <div className="flex justify-between pt-1 text-secondary">
          <span>Est. Delivery</span>
          <span className="font-semibold text-luxuryBlack flex items-center gap-1">
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-6 max-w-sm mx-auto">
        <button 
          ...
          className="flex-grow bg-luxuryBlack hover:bg-primary-glow text-white py-3 text-xs uppercase font-semibold font-sans tracking-wider transition-colors rounded"
        >
          Track My Order
        </button>
        <button 
          onClick={() => navigate('/shop')}
          className="flex-grow border border-surface-container hover:bg-surface text-luxuryBlack py-3 text-xs uppercase font-semibold font-sans tracking-wider transition-colors rounded flex items-center justify-center gap-2"
        >
